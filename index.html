...
<head>
    ...
    <!--====== Title ======-->
    <title>Softronix Solutions</title>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        <div class="features-title-icon d-flex justify-content-between">
                            <h4 class="features-title"><a href="#">Mobile App/ Game Development</a></h4>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        <div class="features-title-icon d-flex justify-content-between">
                            <h4 class="features-title"><a href="#">Website Application</a></h4>
                            <div class="features-icon">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        <div class="features-title-icon d-flex justify-content-between">
                            <h4 class="features-title"><a href="#">Software Integration</a></h4>
                            <div class="features-icon">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="portfolio-menu text-center mt-50">
                        <ul>
                            ...
                            <li data-filter=".branding-4">MOBILE GAME</li>
                            <li data-filter=".marketing-4">WEB DEVELOPMENT</li>
                            <li data-filter=".planning-4">MOBILE APP</li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section-title text-center pb-25">
                        ...
                        <p class="text">Stop wasting time and money creating and managing a website/mobile game that doesn’t get results. Happiness guaranteed!</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section-title text-center pb-30">
                        ...
                        <p class="text">Stop wasting time and money creating and managing a website/mobile app that doesn’t get results. Happiness guaranteed!</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="team-style-eleven text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0s">
                        <div class="team-image">
                            <img src="assets/images/marky.jpg" alt="Team">
                        </div>
                        <div class="team-content">
                            ...
                            <h4 class="team-name"><a href="#">Mark Jalandoni</a></h4>
                 ...
                 <div class="col-lg-4 col-sm-6">
                    <div class="team-style-eleven text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0s">
                        <div class="team-image">
                            <img src="assets/images/mark2.jpg" alt="Team">
                        </div>
                        <div class="team-content">
                            <div class="team-social">
                                <ul class="social">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="team-style-eleven text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0s">
                        <div class="team-image">
                            <img src="assets/images/mark3.jpg" alt="Team">
                        </div>
                        <div class="team-content">
                            <div class="team-social">
                                <ul class="social">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-map mt-30">
                        <iframe id="gmap_canvas" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7733.3012158475785!2d120.8912669909977!3d14.273680037469758!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bd8183cd15a1b5%3A0x42b49911fabd4865!2sKarlaville%20-%20Trece%20Martires!5e0!3m2!1sen!2sph!4v1622522385983!5m2!1sen!2sph" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                    </div> <!-- row -->
                </div>
            </div> <!-- row -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-1 mt-30 d-flex ">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text"> Karlaville Parkhomes, Cavite<br>4109 Philippines.</p>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-2 mt-30 d-flex ">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">jalandoni.markleo@gmail.com</p>
                            </div>
                        </div> <!-- single contact info -->
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-3 mt-30 d-flex ">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">+639 477-778-768</p>
                                <p class="text">+639 351-625-863</p>
                            </div>
                        </div> <!-- single contact info -->
                    </div>
                </div> <!-- row -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <ul class="social text-center mt-60">
                        <li><a href="https://facebook.com/jalandoni.markleo"><i class="lni lni-facebook-filled"></i></a></li>
                        <li><a href="https://twitter.com/markleoj1"><i class="lni lni-twitter-original"></i></a></li>
                        <li><a href="https://instagram.com/marky.leo"><i class="lni lni-instagram-original"></i></a></li>
                        <li><a href="#"><i class="lni lni-linkedin-original"></i></a></li>
                    </ul> <!-- social -->
                    <div class="footer-support text-center">
                        <span class="number">+639477778768</span>
                        <span class="mail">jalandoni.markleo@gmail.com</span>
                    </div>
                    <div class="copyright text-center mt-35">
                        <p class="text">Designed by <a href="#" rel="nofollow">Mark Jalandoni</a></p>
                    </div> <!--  copyright -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
